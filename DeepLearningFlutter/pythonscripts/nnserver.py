...
# go to folder -> flask -> enter 3 line code
# set FLASK_APP=nnserver.py
...
def get_model():
    global model 
    model = load_model('shoes_model.h5')# model = load_model('goodnn.h5')
    print(' * MODEL LOADED')
...
def preprocess_image(image, target_size):
    ...
    image = (image - 127.5) / 127.5 #normalize image
