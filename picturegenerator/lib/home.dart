...
class _HomeState extends State<Home> {
  ...
  void fetchResponse(File imageFile) async {
    ...
    final imageUploadRequest = http.MultipartRequest(
        'POST',
        Uri.parse(
            'http://10.0.2.2:5000/generate')); //PUT YOUR OWN IP HERE, it may vary depending on your computer
...
//then your server endpoint should be 10.0.2.2:8000 instead of localhost:8000 
//as AVD uses 10.0.2.2 as an alias to your host loopback interface (i.e) 

//ipv4
  void displayResponseImage(String fileName) async {
    setState(() {
      String outputFile = 'http://10.0.2.2:5000/download/' + fileName; // 10.0.2.2 => emulators
